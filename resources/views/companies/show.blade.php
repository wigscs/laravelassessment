            ...
            <div class="text-right">
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900 flex justify-between">
                        <div class="flex mr-4">
                            <div class="mr-4 hidden sm:flex justify-center">
                        ...
                        <div class="space-y-1 text-right pl-6 my-auto">
                            ...
                            <form method="POST" action="{{ route('company.destroy', $company) }}" class="inline-block">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="bg-red-600 hover:bg-red-600/90 rounded py-1 px-4 text-white font-bold">Delete</button>
                            </form>
                        </div>
                    </div>
                </div>
